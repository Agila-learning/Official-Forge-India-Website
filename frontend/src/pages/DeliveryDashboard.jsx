...
const DeliveryDashboard = () => {
 ...
 <h3 className="text-3xl font-black mb-8 uppercase tracking-tighter">Fleet <span className="text-orange-500">Deployments</span></h3>
 ...
 <p className="text-xs font-black text-gray-400 uppercase tracking-widest">All units idle. Waiting for deployment signals.</p>
 </div>
 )}
 </div>
 </div>
 ...
 <h3 className="text-5xl font-black tracking-tighter mb-4">₹{stats.earnings}</h3>
 ...
 <h3 className="text-3xl font-black uppercase tracking-tighter mb-2">Fleet <span className="text-orange-500">Ready</span></h3>
 ...
 <h3 className="text-4xl font-black text-gray-900 dark:text-white mb-4 uppercase tracking-tighter">Delivery Agent <span className="text-orange-500">Profile</span></h3>
