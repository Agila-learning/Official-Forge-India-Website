...
const TrainerDashboard = () => {
 ...
 <div>
 <h2 className="font-black text-xl uppercase tracking-tighter">FIC <span className="text-teal-500">Trainer</span></h2>
 ...
 <h1 className="text-2xl font-black uppercase tracking-tighter">{activeTab.replace('-', ' ')}</h1>
 </div>
 ...
 <h3 className="text-2xl font-black uppercase tracking-tighter">Ongoing <span className="text-teal-500">Batches</span></h3>
 ...
 <p className="font-black uppercase text-xs tracking-widest">No active batches assigned.</p>
 ...
 <p className="text-[9px] font-black text-gray-500 uppercase tracking-widest">Course Progress</p>
 ...
 <div>
 <h3 className="text-2xl font-black uppercase tracking-tighter">Learner <span className="text-teal-500">Directory</span></h3>
 <p className="text-[10px] font-black text-gray-500 uppercase tracking-widest mt-1">Track performance and attendance</p>
 </div>
 ...
 <td className="py-8 text-[10px] font-black uppercase tracking-widest text-gray-400">{student.enrolledBatch?.batchId || 'N/A'}</td>
 <td className="py-8">
 <div className="flex items-center gap-4">
 <div className="w-24 h-1.5 bg-gray-800 rounded-full overflow-hidden">
 ...
 {candidates.length === 0 && (
 <tr>
 <td colSpan={6} className="py-20 text-center text-gray-600 uppercase tracking-widest font-black text-xs">No candidates found in your batches.</td>
 </tr>
 )}
 </tbody>
 </table>
