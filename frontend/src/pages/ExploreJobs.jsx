...
const ExploreJobs = () => {
 ...
 <h3 className="text-4xl font-black text-white mb-4 uppercase tracking-tighter">Building a <span className="text-primary">Team?</span></h3>
 ...
 <h3 className="text-4xl font-black text-white mb-4 uppercase tracking-tighter">Seeking <span className="text-secondary">Growth?</span></h3>
 ...
 <h3 className="text-xl font-black text-white tracking-tighter uppercase">Refine <span className="text-primary tracking-normal">Search</span></h3>
...
const FilterPanel = ({ filters, setFilters, experienceLevels, jobTypes, onReset, isMobile = false }) => (
 ...
 {!isMobile && (
 <h3 className="text-lg font-black mb-10 flex items-center gap-2 text-gray-900 dark:text-white uppercase tracking-tighter">
 ...
 <div>
 <label className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-[0.2em] block mb-6 flex items-center gap-3">
