        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
           ...
           <div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-[3rem] p-10 md:p-14 text-white relative overflow-hidden shadow-2xl">
              ...
              <div className="relative z-10 flex flex-col h-full justify-between">
                <div>
                   <h4 className="text-2xl font-black uppercase tracking-tighter italic mb-4">Strategic <br/>Growth.</h4>
                   <p className="text-white/70 text-sm font-medium leading-relaxed max-w-xs italic">Deploy your property on the global Forge India network and reach 50,000+ verified guests monthly.</p>
                </div>
