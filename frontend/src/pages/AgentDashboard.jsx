...
const AgentDashboard = () => {
 ...
 Agent <span className="text-primary">Command Hub</span>
 </h1>
 ...
 <h2 className="text-2xl font-black text-slate-900 dark:text-white mb-4 uppercase tracking-tighter">System Integration <span className="text-primary">Pending</span></h2>
