...
const OrderTracking = () => {
 ...
 <h2 className="text-2xl font-black uppercase tracking-tighter">Mission Not Found</h2>
 ...
 <h1 className="text-4xl md:text-5xl font-black text-gray-900 dark:text-white tracking-tight uppercase">Track <span className="text-primary">Mission</span></h1>
 ...
 <h3 className="text-lg font-black uppercase tracking-tighter mb-8">Inventory <span className="text-primary">Payload</span></h3>
 ...
 <h3 className="text-lg font-black uppercase tracking-tighter mb-6">Execution <span className="text-white/60">Details</span></h3>
 ...
 <p className="text-xs font-black uppercase tracking-widest">{order.fulfillmentType}</p>
 </div>
 </div>
 <div>
 ...
 {/* Partner Support */}
 <div className="bg-white dark:bg-dark-card p-10 rounded-[3rem] border border-gray-100 dark:border-gray-800 shadow-xl">
 <h3 className="text-lg font-black uppercase tracking-tighter mb-6">Strategic <span className="text-secondary">Support</span></h3>
 <div className="space-y-6">
 ...
 <p className="text-lg font-black uppercase tracking-tighter">Rate this <br/>Experience</p>
 </div>
 ...
 <h3 className="text-2xl font-black uppercase tracking-tighter mb-2">Share Your <span className="text-primary">Intelligence</span></h3>
