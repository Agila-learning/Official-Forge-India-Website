...
function ExploreShop() {
 ...
 <h3 className="text-2xl font-black mb-2 uppercase tracking-tighter">No items discovered</h3>
 ...
 <div>
 <h3 className="text-3xl font-black text-gray-900 dark:text-white tracking-tighter uppercase">Recently <span className="text-primary">Viewed</span></h3>
