                                ...
                                <div className="p-8 space-y-6">
                                    ...
                                    <div className="pt-8 flex justify-between items-end">
                                        <div className="text-left">
                                            ...
                                            <p className="text-4xl font-black text-gray-900 dark:text-white tracking-tighter italic">₹{(addMembership ? baseTotal + membershipPrice : baseTotal).toLocaleString()}</p>
                                        </div>
                                    </div>
