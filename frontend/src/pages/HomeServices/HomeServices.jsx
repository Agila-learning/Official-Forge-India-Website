...
const HomeServices = () => {
 ...
 className="text-5xl md:text-8xl font-black mb-8 tracking-tighter leading-[0.85]"
 >
 ...
 <div>
 <h2 className="text-4xl font-black uppercase tracking-tighter">Mission <span className="text-blue-500">Deployments</span></h2>
 ...
 <h4 className="text-2xl font-black uppercase tracking-tighter mb-4">{s.name}</h4>
 <p className="text-sm text-white/40 font-medium leading-relaxed mb-8 line-clamp-2">
 {s.description}
 </p>
