      ...
      <div className="space-y-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div>
            ...
            <h1 className="text-4xl md:text-6xl font-black text-gray-900 dark:text-white uppercase tracking-tighter italic leading-none">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
           ...
           <div className="bg-gradient-to-br from-orange-500 to-red-600 rounded-[3rem] p-10 md:p-14 text-white relative overflow-hidden shadow-2xl">
              ...
              <div className="relative z-10 flex flex-col h-full justify-between">
                <div>
                   <h4 className="text-2xl font-black uppercase tracking-tighter italic mb-4">Pilot <br/>Optimization.</h4>
                   <p className="text-white/70 text-sm font-medium leading-relaxed max-w-xs italic">Maximize your duty cycles with our AI-powered heatmaps. Deploy your units where demand is highest.</p>
                </div>
