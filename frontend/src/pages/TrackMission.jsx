...
const TrackMission = () => {
 ...
 <h1 className="text-4xl md:text-5xl font-black text-gray-900 dark:text-white tracking-tight uppercase leading-none">Mission <span className="text-primary">Tracker</span></h1>
 ...
 <h3 className="text-xl font-black uppercase tracking-tighter">Mission <span className="text-primary">Inventory</span></h3>
 ...
 <p className="text-xs font-black uppercase tracking-tight">{order.fulfillmentType}</p>
 </div>
 </div>
 <div className="flex items-center gap-4">
 <div className="w-10 h-10 bg-white/20 rounded-xl flex items-center justify-center">
 ...
 <p className="text-xs font-black uppercase tracking-tight">{order.paymentMethod} Authorized</p>
 </div>
 </div>
 </div>
 </div>
 ...
 <h4 className="text-lg font-black text-gray-900 dark:text-white uppercase tracking-tighter">Forge Hotline</h4>
 </div>
 </div>
 ...
 <h4 className="text-xl font-black uppercase tracking-tighter leading-none">Rate Your <br/>Experience</h4>
 </div>
 ...
 <h3 className="text-3xl font-black uppercase tracking-tighter mb-4 leading-none">Share Your <span className="text-primary">Intelligence</span></h3>
