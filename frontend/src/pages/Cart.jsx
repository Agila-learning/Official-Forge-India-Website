...
const Cart = () => {
 ...
 <span className="text-[10px] font-black text-gray-900 dark:text-white uppercase">{v}</span>
 </div>
 ))}
 </div>
 ...
 <span key={mini.id} className="px-3 py-1 bg-secondary/10 text-secondary text-[9px] font-black rounded-lg border border-secondary/20 uppercase">
