...
const TrainingPlacementPage = () => {
 ...
 <div>
 <h2 className="text-3xl md:text-5xl font-black text-white tracking-tight uppercase mb-2">Ready to <span className="text-orange-500">Launch</span> Your Career?</h2>
