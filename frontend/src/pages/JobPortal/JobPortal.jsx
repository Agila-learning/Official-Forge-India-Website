...
const JobPortal = () => {
 ...
 Forge Your <span className="text-primary">Future.</span>
 </h1>
 ...
 <h3 className="text-4xl font-black mb-4 uppercase tracking-tighter text-gray-900 dark:text-white">Apply for <span className="text-primary">Jobs</span></h3>
 ...
 <h3 className="text-4xl font-black mb-4 uppercase tracking-tighter text-gray-900 dark:text-white">Post a <span className="text-purple-500">Job</span></h3>
