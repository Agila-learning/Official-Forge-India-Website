...
const ServiceWizard = () => {
 ...
 <div>
 <h1 className="text-3xl font-black uppercase tracking-tighter">Mission <span className="text-secondary">Configuration</span></h1>
 ...
 <h2 className="text-4xl font-black uppercase tracking-tighter">Property <span className="text-secondary">Deployment.</span></h2>
 <p className="text-gray-500 font-medium mt-2">Identify the architecture of the service location.</p>
 </div>
 ...
 <div className="space-y-12">
 <div className="text-center">
 <h2 className="text-4xl font-black uppercase tracking-tighter">Unit <span className="text-secondary">Metrics.</span></h2>
 <p className="text-gray-500 font-medium mt-2">Specify the volumetric scale of the operation.</p>
 </div>
 ...
 <h2 className="text-4xl font-black uppercase tracking-tighter">Condition <span className="text-secondary">Status.</span></h2>
 ...
 <div className="text-center">
 <h2 className="text-4xl font-black uppercase tracking-tighter">Service <span className="text-secondary">Config.</span></h2>
 <p className="text-gray-500 font-medium mt-2">Select additional mission parameters.</p>
 </div>
 ...
 <div className="md:col-span-2 py-10 text-center text-gray-400 font-medium">
 ...
 <div className="space-y-12">
 <div className="text-center">
 <h2 className="text-4xl font-black uppercase tracking-tighter">Sync <span className="text-secondary">Schedule.</span></h2>
 <p className="text-gray-500 font-medium mt-2">Select an available execution window.</p>
 </div>
 <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
 ...
 <div className="space-y-12">
 <div className="text-center">
 <h2 className="text-4xl font-black uppercase tracking-tighter">Fulfillment <span className="text-secondary font-black">Ledger.</span></h2>
 </div>
 ...
 <div className="text-[9px] font-black text-gray-400 uppercase tracking-[0.5em]">Configuration {step} of 6</div>
 </div>
 )}
 </div>
 ...
 <h4 className="text-xl font-black text-white tracking-tighter">₹{calculateTotal().total.toFixed(0)} <span className="text-[10px] font-bold text-gray-500 uppercase ml-2">(+GST)</span></h4>
 </div>
 </div>
 <button 
 onClick={nextStep}
