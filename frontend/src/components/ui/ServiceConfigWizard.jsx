...
const ServiceConfigWizard = ({ product, onAddToCart }) => {
 ...
 <div>
 <h4 className="text-xl font-black uppercase tracking-tighter leading-tight text-gray-900 dark:text-white">{product.name}</h4>
 <p className="text-[10px] font-black text-primary uppercase tracking-[0.3em] mt-1">{product.serviceType} Specialist</p>
 </div>
 </div>
 ...
 <div key={i} className="flex items-center gap-3 p-3 text-[10px] font-bold text-gray-400 uppercase tracking-tight">
 ...
 <p className="text-[9px] font-black uppercase tracking-widest opacity-60">Verified Inclusion</p>
 ...
 <h4 className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-400">Phase <span className="text-primary">{step + 1} of {mainSteps.length}</span></h4>
 </div>
 {(step >= 2) && (
 <div className="px-5 py-2 bg-primary/5 border border-primary/20 rounded-full flex items-center gap-3">
 <span className="text-[9px] font-black uppercase text-primary tracking-widest">Est. Flow:</span>
 ...
 <h3 className="text-2xl font-black uppercase tracking-tighter text-gray-900 dark:text-white">Property <span className="text-primary">Selection</span></h3>
 ...
 {step === 1 && (
 <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-8">
 <h3 className="text-2xl font-black uppercase tracking-tighter text-gray-900 dark:text-white">Current <span className="text-secondary">Condition</span></h3>
 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
 {[
 ...
 <div className="space-y-6">
 <h3 className="text-2xl font-black uppercase tracking-tighter">BHK <span className="text-primary">Configuration</span></h3>
 ...
 <div className="space-y-6">
 <h3 className="text-2xl font-black uppercase tracking-tighter">Area <span className="text-primary">Coverage</span></h3>
 ...
 {step === 3 && (
 <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-8">
 <h3 className="text-2xl font-black uppercase tracking-tighter">Mini <span className="text-secondary">Services</span></h3>
 ...
 <h3 className="text-3xl font-black uppercase tracking-tighter text-center">Service <span className="text-primary">Quotation</span></h3>
 ...
 <span className="text-[9px] font-black uppercase text-primary tracking-[0.2em]">Statutory GST ({gstPercentage}%)</span>
 ...
 <span className="text-[10px] font-black uppercase tracking-[0.3em]">Final Authorization</span>
 <span className="text-3xl font-black text-primary">₹{pricing.total.toLocaleString()}</span>
 </div>
 </div>
 </div>
 </motion.div>
 ...
 {step === 5 && (
 <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-8">
 <h3 className="text-2xl font-black uppercase tracking-tighter">Deployment <span className="text-primary">Schedule</span></h3>
 <div className="space-y-10">
 <div className="space-y-4">
 <label className="text-[10px] font-black uppercase text-primary tracking-[0.2em] ml-4 flex items-center gap-2">
 ...
 className="space-y-4"
 >
 <label className="text-[10px] font-black uppercase text-secondary tracking-[0.2em] ml-4 flex items-center gap-2">
 ...
 <h3 className="text-3xl font-black uppercase tracking-tighter">PRE-BOOK <span className="text-primary">CONFIRMATION</span></h3>
 ...
 <span className="text-[9px] font-black uppercase">{s.value}</span>
 </div>
 ))}
 ...
 <span className="text-[9px] font-black uppercase text-primary">{bookingDate} • {bookingTime.split(' - ')[0]}</span>
 </div>
 </div>
 ...
 <span className="text-[9px] font-black text-secondary">₹{(mini.price * (mini.qty || 1)).toLocaleString()}</span>
 </div>
 ))}
 {selectedMiniServices.length === 0 && (
 <p className="py-6 text-center text-[8px] font-black uppercase text-gray-300 tracking-[0.2em]">Zero add-ons detected</p>
 )}
 </div>
 </div>
 </div>
 ...
 <p className="text-[9px] font-black uppercase tracking-[0.3em] text-primary mb-1">Authenticated Authorization</p>
 <p className="text-2xl font-black tracking-tighter">PRE-BOOK <span className="text-gray-400">NOW</span></p>
 </div>
 </div>
 <div className="text-right">
 <p className="text-[8px] font-black uppercase text-gray-400 mb-1">Final Payable Total</p>
 <p className="text-2xl font-black tracking-tighter text-primary">₹{pricing.total.toLocaleString()}</p>
 </div>
 </button>
 </motion.div>
 )}
