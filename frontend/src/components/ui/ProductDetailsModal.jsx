...
const ProductDetailsModal = ({ product, isOpen, onClose, onAddToCart, onToggleFavorite, isFavorite }) => {
 ...
 <span className="font-bold text-gray-700 dark:text-gray-200 text-sm">"{item}"</span>
 </div>
 ))}
 </div>
 </div>
 ...
 <div>
 <h3 className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-6">Elite Highlights</h3>
 ...
 <p className="text-lg text-gray-400 line-through mb-1.5">₹{(product.price * 1.25).toLocaleString()}</p>
 </div>
 </div>
