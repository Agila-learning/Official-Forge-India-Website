...
const BookingFlowManager = ({ product, isOpen, onClose, onComplete }) => {
 ...
 <h3 className="text-2xl font-black mb-4 uppercase tracking-tighter text-gray-900 dark:text-white">Access <span className="text-red-500">Denied.</span></h3>
 ...
 <div>
 <p className="font-black text-sm uppercase">Custom Scheduling</p>
 ...
 <h4 className="text-xl font-black uppercase tracking-tighter mb-2">Shop Pickup Point</h4>
 ...
 <div>
 <h4 className="text-xl font-black text-gray-900 dark:text-white">{product.name}</h4>
 ...
 <p className="text-[10px] font-bold text-gray-600 dark:text-gray-400 leading-relaxed">"{instructions}"</p>
 </div>
 </div>
 )}
 </div>
