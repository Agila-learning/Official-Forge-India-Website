...
const ReviewCard = ({ name, location, delay = 0, review, rating, image }) => {
 ...
 <h4 className="text-xl font-black text-gray-900 dark:text-white leading-none uppercase tracking-tighter">
 {name}
 </h4>
 ...
 <p className="text-gray-600 dark:text-gray-300 font-medium leading-relaxed line-clamp-3">
 "{review}"
 </p>
