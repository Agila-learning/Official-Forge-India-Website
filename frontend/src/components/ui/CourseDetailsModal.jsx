...
const CourseDetailsModal = ({ isOpen, onClose, course }) => {
 ...
 <h3 className="text-3xl md:text-4xl font-black text-gray-900 dark:text-white uppercase tracking-tighter leading-none">
 {course.title.split(' ').map((word, i) => i === course.title.split(' ').length - 1 ? <span key={i} className="text-primary">{word} </span> : word + ' ')}
 </h3>
 </div>
 ...
 <p className="text-xl font-black">Industrial</p>
 </div>
 </div>
 ...
 <p className="text-gray-600 dark:text-gray-400 font-medium leading-relaxed text-lg text-center px-4">
 "{course.description}"
 </p>
 </div>
 ...
 <h4 className="text-[11px] font-black uppercase tracking-[0.3em] text-primary">Learning Journey</h4>
 ...
 <h5 className="font-black uppercase tracking-tight text-gray-900 dark:text-white mb-2 flex items-center gap-2">
 {step.step}
 ...
 <h5 className="text-xl font-black uppercase tracking-tight mb-6">{module.module}</h5>
 ...
 <p className="text-gray-400 font-bold uppercase tracking-widest text-xs">Full Syllabus available upon enrollment</p>
 </div>
 )}
 </div>
 </div>
