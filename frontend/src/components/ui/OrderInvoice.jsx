...
const OrderInvoice = ({ order }) => {
 ...
 <p className="text-[10px] text-gray-400 font-bold mt-1 uppercase">{item.isService ? 'Professional Service' : 'Product Inventory'}</p>
 </td>
 ...
 <p className="text-xs text-gray-600 dark:text-gray-400 font-bold">"{order.instructions}"</p>
 </div>
 )}
 </div>
 ...
 <span className="text-xl font-black tracking-tighter uppercase">Total Volume</span>
