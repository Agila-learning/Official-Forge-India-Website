            ...
            <div className="container-xl px-6">
                <div className="flex flex-col md:flex-row items-end justify-between mb-16 gap-8">
                    <div className="max-w-2xl">
                        ...
                        >
                            EXPLORE THE <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary italic">ECOSYSTEM.</span>
                        </motion.h2>
                    </div>
                    <motion.p 
                        initial={{ opacity: 0 }}
                        ...
                        className="text-sm text-gray-500 font-bold uppercase tracking-widest max-w-xs md:text-right italic"
                    >
                ...
                >
                    ...
                    <div className="relative z-10">
                        <h4 className="text-3xl font-black text-white uppercase tracking-tighter italic mb-2">Become a Verified <span className="text-blue-500">Partner.</span></h4>
