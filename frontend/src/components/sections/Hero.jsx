...
import { 
  ArrowRight, MapPin, Zap, Code, Smartphone, GraduationCap, Truck
} from 'lucide-react';
...
const Hero = () => {
  ...
  const fullText = "One Platform. Multiple Business Solutions.";
          ...
          <div className="lg:col-span-7 space-y-10 min-w-0 overflow-hidden">
            ...
            <div className="space-y-4">
              ...
              <p className="text-lg md:text-2xl text-white/50 font-medium max-w-2xl leading-relaxed">
                Integrated Workforce, Customer & Business Operations Ecosystem.
              </p>
            </div>

            <div className="flex flex-wrap gap-4 pt-4">
              <a href="#choose-path" className="btn-primary group flex items-center gap-2">
              ...
              <Link to="/register" className="px-10 py-5 bg-transparent border border-primary/30 text-primary font-black rounded-[1.25rem] text-xs uppercase tracking-[0.2em] hover:bg-primary/5 transition-all flex items-center gap-2">
                Join as Partner
              </Link>
            </div>
