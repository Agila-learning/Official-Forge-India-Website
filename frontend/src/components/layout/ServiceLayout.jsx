...
const ServiceLayout = ({ title, description, benefits, imageSrc, seoDesc, actions, process, trustPoints }) => {
 ...
 className="text-5xl md:text-7xl font-black text-primary mb-6 tracking-tighter uppercase"
 >
 ...
 <h2 className="text-4xl font-black mb-8 uppercase tracking-tighter">Premium <span className="text-primary">Excellence.</span></h2>
 ...
 <h3 className="text-3xl font-black mb-16 text-center uppercase tracking-tighter">Our Fulfillment <span className="text-primary">Protocol.</span></h3>
