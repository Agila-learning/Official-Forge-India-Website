...
const DashboardLayout = ({ 
 ...
 <h3 className="text-lg font-black uppercase tracking-tighter">Alerts <span className="text-primary">&</span> Updates</h3>
 ...
 <p className="text-xs font-black text-gray-400 uppercase tracking-widest">All systems clear.</p>
 </div>
 ) : (
 notifications.map((n) => (
 <div 
