...
const ServiceBuilder = ({ initialConfig = { steps: [], miniServices: [] }, initialPricing = {}, onSave }) => {
 ...
 />
 <p className="text-[8px] text-gray-400 uppercase ml-1">(Use this in pricing/conditions)</p>
 </div>
 </div>
 </div>
 ))}
 ...
 <button onClick={addStep} className="w-full py-8 bg-primary/10 text-primary border-2 border-dashed border-primary/20 rounded-[2.5rem] font-black uppercase tracking-[0.2em] text-sm hover:bg-primary/20 transition-all">
 ...
 <h3 className="text-2xl font-black tracking-tighter uppercase">Mini Service <span className="text-primary">Add-ons</span></h3>
 ...
 <h3 className="text-xl font-black mb-2 uppercase">Advanced <span className="text-primary">Pricing Logic</span></h3>
