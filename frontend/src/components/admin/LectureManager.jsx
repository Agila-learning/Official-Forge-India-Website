...
const LectureManager = () => {
 ...
 <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mt-1">Organize your course content</p>
 </div>
 ...
 <p className="text-xs text-gray-500 font-medium leading-relaxed line-clamp-2">{lecture.description || 'No description provided.'}</p>
 </div>
 ))}
