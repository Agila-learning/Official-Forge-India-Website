...
const HomeServiceCMS = ({ data: globalData, onUpdate: onGlobalUpdate, isVendorMode = false }) => {
 ...
 <h2 className="text-4xl font-black uppercase tracking-tighter">Hero Section <span className="text-primary">Dynamics</span></h2>
 </div>
 </div>
 ...
 className="w-full px-6 py-4 rounded-2xl border border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-dark-bg focus:border-primary/40 outline-none font-bold text-primary"
 />
 </div>
 <div>
...
const StandardsManager = ({ config, setConfig, onSave }) => {
 ...
 <h2 className="text-3xl font-black uppercase tracking-tighter">Operational <span className="text-secondary">Standards</span></h2>
 ...
 <div className="grid grid-cols-2 gap-6">
 <input value={config.standards.labelBefore} onChange={e => setConfig({...config, standards: {...config.standards, labelBefore: e.target.value}})} placeholder="Before Label" className="px-5 py-4 rounded-xl outline-none font-bold text-xs" />
 <input value={config.standards.labelAfter} onChange={e => setConfig({...config, standards: {...config.standards, labelAfter: e.target.value}})} placeholder="After Label" className="px-5 py-4 rounded-xl outline-none font-bold text-xs" />
 </div>
 </div>
 </div>
...
const WorkflowManager = ({ items, onUpdate }) => {
 ...
 return (
 <div className="space-y-10">
 <h2 className="text-3xl font-black uppercase tracking-tighter">Precision <span className="text-primary">Workflow</span></h2>
 ...
 {items.map(step => (
 <div key={step._id} className="flex justify-between items-center p-6 bg-white rounded-2xl border border-gray-100">
...
const TrustManager = ({ items, onUpdate }) => {
 ...
 return (
 <div className="space-y-10">
 <h2 className="text-3xl font-black uppercase tracking-tighter">Trust <span className="text-primary">Signals</span></h2>
 ...
 <h4 className="font-black uppercase tracking-tighter mb-2">{card.title}</h4>
...
const TestimonialManager = ({ items, onUpdate }) => {
 ...
 return (
 <div className="space-y-10">
 <h2 className="text-3xl font-black uppercase tracking-tighter">Customer <span className="text-secondary">Intelligence</span></h2>
 ...
 <div>
 <h4 className="font-black text-lg uppercase">{t.name}</h4>
 ...
 <p className="text-sm font-medium text-gray-600 dark:text-gray-400 leading-relaxed">"{t.content}"</p>
 </div>
 ))}
 {items.length === 0 && <div className="py-20 text-center font-black text-gray-400">No intelligence metrics available</div>}
 </div>
 </div>
 );
};
...
const CategoryManager = ({ items, onUpdate, isVendorMode }) => {
 ...
 return (
 <div className="space-y-10">
 <h2 className="text-3xl font-black uppercase tracking-tighter">Service <span className="text-primary">Verticals</span></h2>
 ...
 <span className="font-black uppercase text-lg leading-tight">{cat.name}</span>
 </div>
...
const SubCategoryManager = ({ categories, onUpdate, isVendorMode }) => {
 ...
 <span className="font-black uppercase text-lg leading-tight">{sub.name}</span>
 </div>
 <div className="flex flex-col">
